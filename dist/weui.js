...
(function ($) {
    ...
    $.fn.swipeOut = function (options) {
        ...
        var isTouched = void 0,
            ...
            touchesDiff = void 0,
            swipeOutEl = void 0,
            swipeOutContent = void 0,
            actionsRight = void 0,
            actionsLeft = void 0,
            actionsLeftWidth = void 0,
            actionsRightWidth = void 0,
            translate = void 0,
            opened = void 0,
            openedActions = void 0,
            buttonsLeft = void 0,
            buttonsRight = void 0,
            direction = void 0,
            overswipeLeftButton = void 0,
            overswipeRightButton = void 0,
            overswipeLeft = void 0,
            overswipeRight = void 0;
    ...
    $.fn.swipeOut.noConflict = function () {
        return oldFnSwipeOut;
    };

    // 打开菜单
    var oldFnSwipeOutOpen = $.fn.swipeOutOpen;
    $.fn.swipeOutOpen = function (dir) {
        ...
        var swipeOutActions = el.find('.weui_swipeout_actions_' + dir);
        ...
        if (buttons.length > 1) {
            for (var i = 0; i < buttons.length; i++) {
                if (dir === 'right') {
                    ...
                    $(buttons[i]).css('z-index', buttons.length - i).css('transform', 'translate3d(' + (swipeOutActionsWidth - buttons[i].offsetWidth - buttons[i].offsetLeft) + 'px,0,0)');
                }
            }
        }
        el.addClass('transitioning');
        for (var _i = 0; _i < buttons.length; _i++) {
            $(buttons[_i]).css('transform', 'translate3d(' + translate + 'px,0,0)');
        }
        el.find('.weui_swipeout_content').css('transform', 'translate3d(' + translate + 'px,0,0)').on('transitionend', function () {
            el.toggleClass('opened');
        });
        $.weui.swipeOutOpenedEl = el;
    };
    $.fn.swipeOutOpen.noConflict = function () {
        return oldFnSwipeOutOpen;
    };

    // 关闭菜单
    var oldFnSwipeOutClose = $.fn.swipeOutClose;
    $.fn.swipeOutClose = function () {
        var el = $(this);
        if (!el.hasClass('weui_swipeout_opened')) {
            return;
        }
        var dir = el.find('.weui_swipeout_actions_opened').hasClass('weui_swipeout_actions_right') ? 'right' : 'left';
        var swipeOutActions = el.find('.weui_swipeout_actions_opened').removeClass('weui_swipeout_actions_opened');
        var buttons = swipeOutActions.children('a');
        var swipeOutActionsWidth = swipeOutActions.outerWidth();
    ...
    $.fn.swipeOutClose.noConflict = function () {
        return oldFnSwipeOutClose;
    };

    // TODO 滑动删除
    var oldFnSwipeOutDelete = $.fn.swipeOutDelete;
    $.fn.swipeOutDelete = function () {};
    $.fn.swipeOutDelete.noConflict = function () {
